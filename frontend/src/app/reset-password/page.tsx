        ...
        <div className="bg-white/[0.03] backdrop-blur-xl border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            <p className="text-gray-400 text-xs">
              {t("الرجاء إدخال كلمة المرور الجديدة الخاصة بك أدناه", "Please enter your new password below")}
            </p>
          </div>

          {done ? (
            <div className="flex flex-col items-center gap-4 text-center py-6">
              <span className="material-symbols-outlined text-5xl text-green-500 animate-pulse">
                check_circle
              </span>
              ...
              <p className="text-gray-400 text-sm">
                {t("جارٍ تحويلك إلى الصفحة الرئيسية...", "Redirecting to Home page...")}
              </p>
            </div>
          ) : (
            <>
